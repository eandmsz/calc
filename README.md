...
## Why we need a better calculator for Linux:
 ...
 - Gnome Calculator is missing useful function buttons like: `√`, `1/x`, `+/-` sure you can type in `sqrt()` but that is why this is an expression solver and not a calculator.
